...
export default defineConfig({
  ...
  plugins: [
    ...
    react(),
    mockApiPlugin(),
    // No service worker: the generated one registered its routes after a
    // throwing createHandlerBoundToURL('/index.html') (index.html is not
    // precached) and cached nothing. public/sw.js retires existing installs;
    // new-version detection lives in hooks/usePWA.ts.
  ],
  ssr: {
