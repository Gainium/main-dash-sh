      ...
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 1, right: 1, left: 1, bottom: 1 }}>
          ...
          <YAxis
            ...
            width={44}
          />
          {/* Invisible right-hand gutter. The panel above carries TWO Y axes
              (equity on the left, realized P&L on the right, 44px each), so its
              plot area is inset on both sides. Without a matching inset here
              this panel's plot runs 44px further right and the two time axes
              drift apart — which looks like a domain bug but is pure layout. */}
          <YAxis
            yAxisId="gutter"
            orientation="right"
            width={44}
