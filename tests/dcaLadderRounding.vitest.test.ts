 ...
 *   NODE_ENV=development npx vitest run core/tests/dcaLadderRounding.vitest.test.ts
 *
 * A DCA bot's safety-order preview must not accumulate tick rounding across
...
describe('DCA safety-order ladder rounding', () => {
